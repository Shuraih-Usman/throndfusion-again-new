    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="row">
        ...
        <ul class="nav nav-pills flex-column flex-md-row m-3">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-edit me-1"></i> Edit Profile</a>
            </li>
            <li class="nav-item">
              ...
              <form id="addform" class="row" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-6 col-md-6 mb-3">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <select name="role" id="select_role" class="form-control" disabled>
                  ...
                  <div class="col-sm-6 col-md-6 mb-3">
                    <div class="input-group input-group-merge">
                        <label class="form-label" for="basic-icon-default-phone"></label>
                      <label class="toggle2">
                        <input name="status" class="toggle-checkbox" type="checkbox" {{$user->status == 1 ? 'checked' : ''}}>
                        <div class="toggle-switch"></div>
                        <span class="toggle-label">Dectivate Your Account</span>
                      </label>
                    </div>
                  </div>
