...
use App\Models\AdminModel\Context_cat;
class Context_cats extends Controller
{
    //
    ...
    public function list($request) 
    {
        ...
        $totalRecords = Context_cat::count();
        ...
        $s = 0;
            ...
            if( $validator->fails() ) {
                ...
                try {
                    ...
                    $campaign = Context_cat::find($request->id);
